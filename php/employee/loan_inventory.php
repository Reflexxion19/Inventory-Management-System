...
if (!isset($_SESSION['loan_inventory_tab_state'])) {
    $_SESSION['loan_inventory_tab_state'] = "open_storage";
}
...
if(isset($_POST['loan'])){
    $loan_id_code = $_POST['loan_id_code'];
    $user_id = $_SESSION['user_id'];

    loanInventory($loan_id_code, $user_id);
}
        ...
        <div class="row <?php echo ($_SESSION['error_message'] === "") ? "mt-5" : "" ?> mb-3 d-flex justify-content-end">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    ...
                    aria-selected="true" onclick="saveState('loan_inventory_tab_state', 'open_storage')">Atrakinti Talpyklą</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link <?php echo ($_SESSION['loan_inventory_tab_state'] === "loan_inventory") ? "active" : "" ?> border-primary border-2" 
                    id="loan-tab" data-bs-toggle="tab" data-bs-target="#loan-tab-pane" type="button" role="tab" aria-controls="loan-tab-pane" 
                    aria-selected="false" onclick="saveState('loan_inventory_tab_state', 'loan_inventory')">Pasiskolinti Inventorių</button>
                </li>
            </ul>
            <div class="tab-content border border-2 rounded-bottom border-primary" id="myTabContent">
                <div class="tab-pane fade <?php echo ($_SESSION['loan_inventory_tab_state'] === "open_storage") ? "show active" : "" ?>" id="storage-tab-pane" role="tabpanel" aria-labelledby="storage-tab" tabindex="0">
                ...
                <div class="tab-pane fade <?php echo ($_SESSION['loan_inventory_tab_state'] === "loan_inventory") ? "show active" : "" ?>" id="loan-tab-pane" role="tabpanel" aria-labelledby="loan-tab" tabindex="0">
                    <div class="row my-5 d-flex justify-content-center">
                        <div class="col-12 mb-3">
                            <form method="post">
