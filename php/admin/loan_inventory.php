                ...
                <div class="tab-pane fade show active" id="storage-tab-pane" role="tabpanel" aria-labelledby="storage-tab" tabindex="0">
                    <div class="row my-5 d-flex justify-content-center">
                        <div class="col-12 mb-3">
                            ...
                            <input type="text" class="form-control mb-3" id="identification_code_storage" placeholder="Pvz.: 321654898798756654"></input>
                ...
                <div class="tab-pane fade" id="loan-tab-pane" role="tabpanel" aria-labelledby="loan-tab" tabindex="0">
                    <div class="row my-5 d-flex justify-content-center">
                        <div class="col-12 mb-3">
                            ...
                            <input type="text" class="form-control mb-3" id="identification_code_loan" placeholder="Pvz.: 321654898798756654"></input>
